...
class CL4SRec(SequentialRecommender):
    ...
    def item_mask(self, item_seq, item_seq_len, gamma=0.3):
        ...
        masked_item_seq[
            mask_index
        ] = self.n_items  # token 0 has been used for semantic masking
        return (
    ...
    def forward(self, item_seq, item_seq_len):
        ...
        output = trm_output[-1]
        # only take hidden from last item's token
        # e.g., for seq: [i1, i2, i3, pad, pad, pad, ...]
        # only take hidden from token[2], i.e., i3
